    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(listItemView == null) {
            listItemView = LayoutInflater.from(getContext()).inflate(
                    R.layout.list_item_visite, parent, false);
        }

        Visite currentVisite = getItem(position);

        TextView textViewIdVisiteur = (TextView) listItemView.findViewById(R.id.textViewIdVisiteur);
        ...
        textViewIdVisiteur.setText(currentVisite.getVisiteur().getNom() + " " + currentVisite.getVisiteur().getPrenom());
