...
public class CreateVisiteurActivity extends Activity {
    EditText editTextNom;
    EditText editTextPrenom;
    Button buttonValider;
    RequestQueue requestQueue;
    String addVisiteurUrl = "http://192.168.1.35:8081/gsb_visiteur/visiteurs/add.json";
            ...
            public void onClick(View v) {
                StringRequest request = new StringRequest(Request.Method.POST, addVisiteurUrl, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(CreateVisiteurActivity.this, "Nouveau Visiteur " + editTextNom.getText().toString() + " "
